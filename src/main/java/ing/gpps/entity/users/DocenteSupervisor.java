...
@Getter
@Setter
@DiscriminatorValue("DOCENTE_SUPERVISOR")
public class DocenteSupervisor extends Usuario implements Notificar {
    ...
    public DocenteSupervisor(String nombre, String apellido, String email, String password, Long numTelefono) {
    ...
    private void procesarNotificacion (String mensaje) {
        try {
            ...
            String asunto = "Notificación para Docente Supervisor " + this.getNombre ();
